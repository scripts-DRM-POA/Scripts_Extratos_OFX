# -*- coding: utf-8 -*-
"""
Extrator multi-layout de extratos bancários (PDF + OFX, sem OCR / sem Tesseract) - v57.2

Uso:
    python extratos_PDFmultilayout_ofx_e_comSenhas_v52.py
ou
    python extratos_PDFmultilayout_ofx_e_comSenhas_v52.py --pasta "C:\\caminho\\dos\\pdfs"
