...
SET PYTHON_PATH=D:\Users\renato.zulke\AppData\Local\anaconda3\python.exe
...
"%PYTHON_PATH%" -c "import sys; sys.path.append(r'%SCRIPT_PATH%'); import processa_ofx_jupyter_v02; processa_ofx_jupyter_v02.process_dir()"
